...
echo "        DocumentRoot /var/www/${SITE}/httpdocs/public" >> /etc/apache2/sites-available/$DOMINIO_CONF
echo "" >> /etc/apache2/sites-available/$DOMINIO_CONF

echo "        <Directory /var/www/$SITE/httpdocs/public/bundles>" >> /etc/apache2/sites-available/$DOMINIO_CONF
...
echo "        <Directory /var/www/$SITE/httpdocs/public>" >> /etc/apache2/sites-available/$DOMINIO_CONF
