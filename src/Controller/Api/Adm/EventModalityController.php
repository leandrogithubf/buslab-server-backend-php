...
/**
 * @Route(
 *     "/api/adm/event-modality",
 *     name="api_adm_event_modality_"
 * )
 */
class EventModalityController extends AbstractApiController
{
    /**
     * @Route(
     *     "/list",
     ...
     * )
     */
    public function showAction(EventModality $entity): JsonResponse
    {
