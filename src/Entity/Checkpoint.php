 ...
 * @ORM\Table(name="checkpoint",indexes={
 *      @ORM\Index(name="search_idx1", columns={"date"}),
 *      @ORM\Index(name="identifierindex", columns={"identifier"}),
 *      @ORM\Index(name="search_idx2", columns={"date", "vehicle_id"}),
 *      @ORM\Index(name="search_idx3", columns={"date", "vehicle_id", "obd_id"})
 * })
 */
class Checkpoint extends BaseEntity\AbstractBaseEntity
{
    ...
    //@ORM\Column(type="integer", nullable=true)
    //private $driverOneWorkingState;

    //@ORM\Column(type="integer", nullable=true)
    //private $driverTwoWorkingState;
    ...
    //@ORM\Column(type="integer", nullable=true)
    //private $driverOneTimeRelatedStates;

    //@ORM\Column(type="integer", nullable=true)
    //private $driverCardOne;

    
    //@ORM\Column(type="integer", nullable=true)
    //private $vehicleOverspeed;

    //@ORM\Column(type="integer", nullable=true)     
    //private $driverTwoTimeRelatedStates;

    //@ORM\Column(type="integer", nullable=true)
    //private $driverCardDriverTwo;
     ...
     * @ORM\Column(type="integer", nullable=true)
     */
    //private $tachographPerformance;

    //@ORM\Column(type="integer", nullable=true)
    //private $directionIndicator;

    //@ORM\Column(type="integer", nullable=true)
    //private $tachographOutputShaftSpeed;
    ...
    //@ORM\Column(type="float", nullable=true)
    //private $enginePercentLoadCurrentSpeed;

    //@ORM\Column(type="float", nullable=true)
    //private $remoteAcceleratorPedalPosition;

    //@ORM\Column(type="float", nullable=true)
    //private $acceleratorPedalPositionTwo;

    //@ORM\Column(type="integer", nullable=true)
    //private $vehicleAccelerationRateLimitStatus;

    //@ORM\Column(type="float", nullable=true)
    //private $actualMaximumAvailableEngine;
    ...
    /* public function getDriverOneWorkingState(): ?int
    {
        return $this->driverOneWorkingState;
    } */

    /* public function setDriverOneWorkingState(?int $driverOneWorkingState): self
    {
        $this->driverOneWorkingState = $driverOneWorkingState;

        return $this;
    } */

    /* public function getDriverTwoWorkingState(): ?int
    {
        return $this->driverTwoWorkingState;
    } */

    /* public function setDriverTwoWorkingState(?int $driverTwoWorkingState): self
    {
        $this->driverTwoWorkingState = $driverTwoWorkingState;

        return $this;
    } */

    /* public function getVehicleMotion(): ?int
    {
        return $this->vehicleMotion;
    }

    public function setVehicleMotion(?int $vehicleMotion): self
    {
    ...
    /* public function getDriverOneTimeRelatedStates(): ?int
    {
        return $this->driverOneTimeRelatedStates;
    }

    public function setDriverOneTimeRelatedStates(?int $driverOneTimeRelatedStates): self
    {
        $this->driverOneTimeRelatedStates = $driverOneTimeRelatedStates;

        return $this;
    } */

    /* public function getDriverCardOne(): ?int
    {
        return $this->driverCardOne;
    }

    public function setDriverCardOne(?int $driverCardOne): self
    {
        $this->driverCardOne = $driverCardOne;

        return $this;
    } */

    /* public function getVehicleOverspeed(): ?int
    {
        return $this->vehicleOverspeed;
    }

    public function setVehicleOverspeed(?int $vehicleOverspeed): self
    {
    ...
    /* public function getDriverTwoTimeRelatedStates(): ?int
    {
        return $this->driverTwoTimeRelatedStates;
    }

    public function setDriverTwoTimeRelatedStates(?int $driverTwoTimeRelatedStates): self
    {
        $this->driverTwoTimeRelatedStates = $driverTwoTimeRelatedStates;

        return $this;
    } */

    /* public function getDriverCardDriverTwo(): ?int
    {
        return $this->driverCardDriverTwo;
    }

    public function setDriverCardDriverTwo(?int $driverCardDriverTwo): self
    {
        $this->driverCardDriverTwo = $driverCardDriverTwo;

        return $this;
    } */

    /* public function getSystemEvent(): ?int
    {
        return $this->systemEvent;
    }

    public function setSystemEvent(?int $systemEvent): self
    {
    ...
    /* public function getHandlingInformation(): ?int
    {
        return $this->handlingInformation;
    }

    public function setHandlingInformation(?int $handlingInformation): self
    {
    ...
    /* public function getTachographPerformance(): ?int
    {
        return $this->tachographPerformance;
    }

    public function setTachographPerformance(?int $tachographPerformance): self
    {
        $this->tachographPerformance = $tachographPerformance;

        return $this;
    } */

    /* public function getDirectionIndicator(): ?int
    {
        return $this->directionIndicator;
    }

    public function setDirectionIndicator(?int $directionIndicator): self
    {
    ...
    /* public function getTachographOutputShaftSpeed(): ?int
    {
        return $this->tachographOutputShaftSpeed;
    }

    public function setTachographOutputShaftSpeed(?int $tachographOutputShaftSpeed): self
    {
        $this->tachographOutputShaftSpeed = $tachographOutputShaftSpeed;
    ...
    public function getEnginePercentLoadCurrentSpeed(): ?float
    {
        return $this->enginePercentLoadCurrentSpeed;
    }

    /* public function setEnginePercentLoadCurrentSpeed(?float $enginePercentLoadCurrentSpeed): self
    {
        $this->enginePercentLoadCurrentSpeed = $enginePercentLoadCurrentSpeed;

        return $this;
    } */

   /*  public function getRemoteAcceleratorPedalPosition(): ?float
    {
        return $this->remoteAcceleratorPedalPosition;
    } */

    /* public function setRemoteAcceleratorPedalPosition(?float $remoteAcceleratorPedalPosition): self
    {
        $this->remoteAcceleratorPedalPosition = $remoteAcceleratorPedalPosition;

        return $this;
    } */

    /* public function getAcceleratorPedalPositionTwo(): ?float
    {
        return $this->acceleratorPedalPositionTwo;
    } */

    /* public function setAcceleratorPedalPositionTwo(?float $acceleratorPedalPositionTwo): self
    {
        $this->acceleratorPedalPositionTwo = $acceleratorPedalPositionTwo;

        return $this;
    } */

    /* public function getVehicleAccelerationRateLimitStatus(): ?int
    {
        return $this->vehicleAccelerationRateLimitStatus;
    } */

    /* public function setVehicleAccelerationRateLimitStatus(?int $vehicleAccelerationRateLimitStatus): self
    {
        $this->vehicleAccelerationRateLimitStatus = $vehicleAccelerationRateLimitStatus;

        return $this;
    } */

    /* public function getActualMaximumAvailableEngine(): ?float
    {
        return $this->actualMaximumAvailableEngine;
    } */

    /* public function setActualMaximumAvailableEngine(?float $actualMaximumAvailableEngine): self
    {
        $this->actualMaximumAvailableEngine = $actualMaximumAvailableEngine;
