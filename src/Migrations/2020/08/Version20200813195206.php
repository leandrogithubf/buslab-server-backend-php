 ...
 */
final class Version20200813195206 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE parameter_configuration ADD convoy TIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE parameter_configuration DROP convoy');
    }
}
