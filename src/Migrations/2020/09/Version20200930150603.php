 ...
 */
final class Version20200930150603 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE schedule_date CHANGE collector_id collector_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE schedule_date CHANGE collector_id collector_id INT NOT NULL');
    }
}
