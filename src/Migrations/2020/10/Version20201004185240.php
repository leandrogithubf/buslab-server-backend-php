 ...
 */
final class Version20201004185240 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trip CHANGE driver_id driver_id INT DEFAULT NULL, CHANGE company_id company_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trip CHANGE driver_id driver_id INT NOT NULL, CHANGE company_id company_id INT NOT NULL');
    }
}
