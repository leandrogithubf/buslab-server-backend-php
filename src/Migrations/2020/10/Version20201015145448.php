 ...
 */
final class Version20201015145448 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sector ADD identifier VARCHAR(15) NOT NULL, ADD description VARCHAR(120) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sector DROP identifier, DROP description');
    }
}
