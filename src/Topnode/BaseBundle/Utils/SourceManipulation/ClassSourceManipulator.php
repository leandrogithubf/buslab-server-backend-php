...
/*
 * @todo Utilizar esta classe com base na SourceManipulation do Symfony, extendendo-a.
 */

namespace App\Topnode\BaseBundle\Utils\SourceManipulation;
...
final class ClassSourceManipulator
{
    ...
    public function addProperty(string $name, array $annotationLines = [], $defaultValue = null)
    {
        ...
        $newPropertyBuilder = (new Builder\Property($name))->makeProtected();
    ...
    private function addNodeAfterProperties(Node $newNode)
    {
        ...
        // otherwise, try to add after the last trait use
        $targetNode = $this->findLastNode(function ($node) {
